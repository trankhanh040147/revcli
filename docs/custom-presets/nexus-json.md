...
**OUTPUT CONSTRAINT:** Return **ONLY** a valid JSON object. No conversational text, no markdown formatting (`json`), just the raw JSON string.
  ...
  "critical": [
    {
      ...
      "fix_code": "string (Optional snippet)"
    }
  ],
  "warning": [
    { "file": "...", "line": 0, "issue": "...", "description": "..." }
  ],
  "refactor": [
    { "file": "...", "line": 0, "issue": "...", "description": "..." }
  ]
