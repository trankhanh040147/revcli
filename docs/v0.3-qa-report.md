...
- [ ] IS09: Fail to edit when enter a different name (Consider disable edit *name*)
- [ ] IS10: Not enter default value when editing (still show default value, so not a big deal)
- [ ] IS11: Can not move cursor up and down when edit *prompt* (verify with create/edit)
