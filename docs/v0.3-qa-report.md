...
### Preset List
- [ ] `revcli preset list` shows all built-in presets
- [ ] `revcli preset list` shows all custom presets
- [ ] Presets display with descriptions
- [ ] Built-in and custom presets are clearly separated
- [ ] Empty custom preset directory handled gracefully

### Preset Create
- [ ] `revcli preset create <name>` creates preset interactively
...
- **verbose error when no name provide**
```bash
